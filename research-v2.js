...
(function(){
  ...
  .r2-edge-grid{display:flex;gap:8px;overflow-x:auto;scroll-snap-type:x mandatory;padding:2px 0 5px;-webkit-overflow-scrolling:touch}.r2-edge-grid::-webkit-scrollbar{display:none}.r2-edge{flex:0 0 min(300px,78vw);scroll-snap-align:start;min-width:0;border-radius:12px;padding:9px;border:1px solid rgba(255,255,255,.08);background:rgba(0,0,0,.16)}.r2-edge>span{font-size:8px;font-weight:1000;letter-spacing:.6px;color:var(--muted)}.r2-edge>div{display:flex;align-items:center;gap:6px;margin-top:6px;min-width:0}.r2-edge .player-avatar{width:29px;height:29px;font-size:8px}.r2-edge strong{font-size:10px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.r2-edge>b{display:block;font-size:16px;margin-top:5px}.r2-edge>small{display:block;margin-top:3px;color:var(--muted);font-size:8px}.r2-edge.top{border-color:rgba(255,182,18,.35)}.r2-edge.top>b{color:var(--yellow)}.r2-edge.advertised{border-color:rgba(255,107,120,.32)}.r2-edge.advertised>b{color:#ff9da6}.r2-edge.hidden{border-color:rgba(105,230,167,.34)}.r2-edge.hidden>b{color:var(--green)}
  ...
  @media(max-width:760px){.r2-ranges{grid-template-columns:1fr repeat(3,48px)}.r2-edge{flex-basis:82vw;display:grid;grid-template-columns:1fr auto;align-items:center}.r2-edge>span{grid-column:1/-1}.r2-edge>div{margin-top:4px}.r2-edge>b{margin:0;font-size:18px}}
  `;
